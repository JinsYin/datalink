...
import cn.guruguru.datalink.protocol.transformation.relation.NodeRelation;
import cn.guruguru.datalink.types.FlinkSqlTypeMapper;
...
public class FlinkSqlParser implements Parser {
    ...
    private static final FlinkSqlTypeMapper typeMapper = new FlinkSqlTypeMapper();
